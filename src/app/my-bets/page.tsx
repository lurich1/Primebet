    ...
    <AppShell tabs={false}>
      ...
      {open.length > 0 ? (
        ...
        <div className="card flex flex-col items-center text-center py-14 px-6">
          ...
          <h3 className="font-display font-bold text-[15px]">No open bets</h3>
          <p className="text-[12.5px] text-[var(--color-ink-faint)] mt-1.5">Place a bet to see it tracked live here.</p>
          <Link href="/" className="mt-5 rounded-xl px-5 py-2.5 font-display font-bold grad-violet-pink text-white text-[13px]">Browse Sports</Link>
        </div>
      )}
