        ...
        9842: function(e, t, n) {
            ...
            i = function() {
                return function(e) {
                    ...
                    e.exports = i,
                        function() {
                            i._nextId = 0, i._seed = 0, i._nowStartTime = +new Date, i._warnedOnce = {}, i._decomp = null, i.extend = function(e, t) {
                                var n, o;
                                "boolean" == typeof t ? (n = 2, o = t) : (n = 1, o = !0);
                                for (var r = n; r < arguments.length; r++) {
                                    var a = arguments[r];
                                    if (a)
                                        for (var s in a) o && a[s] && a[s].constructor === Object ? e[s] && e[s].constructor !== Object ? e[s] = a[s] : (e[s] = e[s] || {}, i.extend(e[s], o, a[s])) : e[s] = a[s]
                                }
                                return e
                                ...
                                return i.get(e, t, 0, -1)[a[a.length - 1]] = n, n
                            ...
                            i.colorToNumber = function(e) {
                                ...
                                var t = [],
                                    n = [],
                                    o = [];
                                for (var r in e) n[r] || o[r] || i._topologicalSort(r, n, o, e, t);
                                return t
                                    ...
                                    if (x && 1 === b)(C = u(d, h, a)) && o.push(C);
                                        ...
                                        for (var S = b > 1 ? 1 : 0, w = g > 1 ? 1 : 0; w < g; w++)
                                            for (var A = d.parts[w], P = (p = A.bounds, S); P < b; P++) {
                                                var C, B = h.parts[P],
                                                    M = B.bounds;
                                                p.min.x > M.max.x || p.max.x < M.min.x || p.max.y < M.min.y || p.min.y > M.max.y || (C = u(A, B, a)) && o.push(C)
                                            }
                                }
                            }
                        }
                            ...
                            if (s.trigger(e, "beforeRender", A), e.currentBackground !== b && v(e, b), y.globalCompositeOperation = "source-in", y.fillStyle = "transparent", y.fillRect(0, 0, f.width, f.height), y.globalCompositeOperation = "source-over", m.hasBounds) {
                                ...
                                for (n = 0; n < h.length; n++) {
                                    var C = h[n],
                                        ...
                                        k = C.pointA,
                                        _ = C.pointB;
                                    B && (k = l.add(B.position, C.pointA)), M && (_ = l.add(M.position, C.pointB)), k && _ && (a.contains(e.bounds, k) || a.contains(e.bounds, _)) && w.push(C)
                                }
                    ...
                    "undefined" != typeof window && (o = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.msRequestAnimationFrame, r = window.cancelAnimationFrame || window.mozCancelAnimationFrame || window.webkitCancelAnimationFrame || window.msCancelAnimationFrame), o || (o = function(e) {
                        ...
                        return void 0 !== e.positionIterations && (t = e, e = i.create()),
                            function n(r) {
                                e.frameRequestId = o(n), r && e.enabled && i.tick(e, t, r)
                            }(), e
                        ...
                        s.trigger(e, "beforeTick", a), e.isFixed ? i = e.delta : (i = n - e.timePrev || e.delta, e.timePrev = n, e.deltaHistory.push(i), e.deltaHistory = e.deltaHistory.slice(-e.deltaSampleSize), r = (i = (i = (i = Math.min.apply(null, e.deltaHistory)) < e.deltaMin ? e.deltaMin : i) > e.deltaMax ? e.deltaMax : i) / e.delta, e.delta = i), 0 !== e.timeScalePrev && (r *= o.timeScale / e.timeScalePrev), 0 === o.timeScale && (r = 0), e.timeScalePrev = o.timeScale, e.correction = r, e.frameCounter += 1, n - e.counterTimestamp >= 1e3 && (e.fps = e.frameCounter * ((n - e.counterTimestamp) / 1e3), e.counterTimestamp = n, e.frameCounter = 0), s.trigger(e, "tick", a), s.trigger(e, "beforeUpdate", a), l.update(t, i, r), s.trigger(e, "afterUpdate", a), s.trigger(e, "afterTick", a)
                    }, i.stop = function(e) {
                        r(e.frameRequestId)
